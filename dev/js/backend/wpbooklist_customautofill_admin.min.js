/**
 * JavaScript Admin Functions - wpbooklist-customautofill-admin.min.js
 *
 * @author   Jake Evans
 * @category JavaScript
...
console.log( wpbooklistCustomAutofillPhpVariables );
...
jQuery( document ).ready( function( $ ) {
	...
	wpbooklistCustomAutofillAdminPointersJavascript();


	/* ENDING SECTION TO CALL ALL FUNCTIONS IN FILE... */

	// Function to display the admin pointer message when entering the Question Mark image with mouse...
	function wpbooklistCustomAutofillAdminPointersJavascript() {
